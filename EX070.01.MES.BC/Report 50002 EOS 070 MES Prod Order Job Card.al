/// <summary>Crated from Standard report 99000762. Added Barcode part</summary>
report 50002 "EOS 070 MES ProdOrderJobCard"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Source/LayoutReport/ProdOrderJobCard.rdlc';
    ...
    dataset
    {
        dataitem("Production Order"; "Production Order")
        {
            ...
            dataitem("Prod. Order Line"; "Prod. Order Line")
            {
                ...
                column(IncludeInPrint; IncludeInPrint)
                {
                }
