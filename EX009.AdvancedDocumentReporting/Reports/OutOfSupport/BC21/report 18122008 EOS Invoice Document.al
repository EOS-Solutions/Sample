report 18122008 "EOS Invoice Document"
{
    ...
    Caption = 'EOS Invoice Document (ADR)';
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = '.\Source\Report\Report 18122008 - EOS Invoice Document.rdlc';
            Caption = 'Default Layout', Locked = true;
        }
        layout(DefaultV2)
        {
            Type = RDLC;
            LayoutFile = '.\Source\Report\Report 18122008 - EOS Invoice Document - v2.rdlc';
