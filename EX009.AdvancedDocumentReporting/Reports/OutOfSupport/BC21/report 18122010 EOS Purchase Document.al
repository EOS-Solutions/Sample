report 18122010 "EOS Purchase Document"
{

    Caption = 'EOS Purchase Document (ADR)';
    ...
    dataset
    {
        ...
        dataitem(HeaderLoop; "EOS Report Buffer Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                column(ShipDateReasonLabel; HeaderLoop."EOS Ship Date/Reason Label") { }
                ...
                dataitem(LineLoop; "EOS Report Buffer Line")
                {
                    ...
                    column(Line_UoMCode; CopyStr(LineLoop.GetUdMTraduction(HeaderLoop), 1, 6)) { }
                    ...
                    column(Line_ShipmentDateReasonCode; LineLoop."EOS Shipment Date/Reason Code") { }
                    column(Line_SecUoMCode; LineLoop."EOS Sec. UoM Code") { }
                    column(Line_SecUnitPrice; LineLoop."EOS Sec. Unit Price") { }
                    column(Line_PriceUoMCode; LineLoop."EOS Price UoM Code") { }
                    column(Line_SecQuantity; LineLoop."EOS Sec. Quantity") { }
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = '.\Source\Report\Report 18122010 - EOS Purchase Document.rdlc';
            Caption = 'Default Layout', Locked = true;
        }
        layout(DefaultV2)
        {
            Type = RDLC;
            LayoutFile = '.\Source\Report\Report 18122010 - EOS Purchase Document - v2.rdlc';
    ...
    labels
    {
        ...
        CustomerVendorNo_Caption = 'Vendor No.';
