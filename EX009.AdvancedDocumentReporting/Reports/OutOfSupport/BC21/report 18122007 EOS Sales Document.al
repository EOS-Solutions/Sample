report 18122007 "EOS Sales Document"
{
            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    field(PrintVATFld; PrintVAT)
                    {
                        Caption = 'Hide VAT';
                        ApplicationArea = All;
                        ToolTip = 'Specifies the value for the field Hide VAT';
                    }
                }
            }
        }
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = '.\Source\Report\Report 18122007 - EOS Sales Document.rdlc';
            Caption = 'Default Layout', Locked = true;
        }
        layout(DefaultV2)
        {
            Type = RDLC;
            LayoutFile = '.\Source\Report\Report 18122007 - EOS Sales Document - v2.rdlc';
