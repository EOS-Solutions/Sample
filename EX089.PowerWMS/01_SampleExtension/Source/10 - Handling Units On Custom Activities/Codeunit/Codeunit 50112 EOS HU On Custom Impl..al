codeunit 50112 "EOS HU On Custom Impl." implements "EOS089 WMS Activity Interface V5"
{
    ...
    begin
        ...
        EOS089WMSActivityInfo."Need Warehouse Employee" := true;
    ...
    var
        EOS089WMSRegCustActHdr: Record "EOS089 WMS Reg. Cus. Act. Hdr.";
    ...
    begin
        ...
        EOS089WMSRegCustActHdr := EOS089WMSCustomActPost.GetRegisteredDocument();
    ...
    begin
        ...
        EOS089WMSCustomActLine_Internal.SetRange(Type, EOS089WMSCustomActLine_Internal.Type::Item);
        EOS089WMSCustomActLine_Internal.SetFilter("Outstanding Qty. (Base)", '<>%1', 0);
        if EOS089WMSCustomActLine_Internal.IsEmpty() then
            exit;

        EOS089WMSCustomActLine_Internal.FindSet(true);
        repeat
            EOS089WMSCustomActLine_Internal.Validate("Qty. To Handle", 0);
            EOS089WMSCustomActLine_Internal.Modify(true);
    ...
    begin
        ...
        TempEOS089WMSSourceInformation."Force Avalable Quantity" := false;
        TempEOS089WMSSourceInformation."Force Zero Quantity" := false;
    end;
    ...
    begin
        EOS089WMSCustomActLine_Internal.Reset();
        EOS089WMSCustomActLine_Internal.SetRange("Activity Type", EOS089WMSActScanDetail."Activity Type");
        ...
        if EOS089WMSActScanDetail."Source Line No." <> 0 then
            EOS089WMSCustomActLine_Internal.SetRange("Line No.", EOS089WMSActScanDetail."Source Line No.");
        EOS089WMSCustomActLine_Internal.SetRange(Type, EOS089WMSCustomActLine_Internal.Type::Item);
        EOS089WMSCustomActLine_Internal.SetRange("Item No.", EOS089WMSActScanDetail."Item No.");
        EOS089WMSCustomActLine_Internal.SetRange("Variant Code 2", EOS089WMSActScanDetail."Variant Code");
        EOS089WMSCustomActLine_Internal.SetFilter("Outstanding Qty. (Base)", '<>%1', 0);
        if EOS089WMSActScanDetail."Source Line No." = 0 then begin
            EOS089WMSCustomActLine_Internal.SetRange("Location Code", EOS089WMSActScanDetail."Location Code");
            EOS089WMSCustomActLine_Internal.SetRange("Bin Code", EOS089WMSActScanDetail."Bin Code");
            EOS089WMSCustomActLine_Internal.SetRange("Unit Of Measure Code", EOS089WMSActScanDetail."Unit Of Measure Code");
        end;

        RecordRef.Open(SourceTable2());
        RecordRef.SetLoadFields(EOS089WMSCustomActLine_Internal.FieldNo("Outstanding Qty. (Base)"), EOS089WMSCustomActLine_Internal.FieldNo("Qty. to Handle (Base)"), EOS089WMSCustomActLine_Internal.FieldNo(SystemId));
        RecordRef.AddLoadFields(EOS089WMSCustomActLine_Internal.FieldNo("Document No."), EOS089WMSCustomActLine_Internal.FieldNo("Line No."), EOS089WMSCustomActLine_Internal.FieldNo("Qty. per Unit of Measure"),
                                EOS089WMSCustomActLine_Internal.FieldNo("Location Code"), EOS089WMSCustomActLine_Internal.FieldNo(Description));
        RecordRef.SetView(EOS089WMSCustomActLine_Internal.GetView(false));
