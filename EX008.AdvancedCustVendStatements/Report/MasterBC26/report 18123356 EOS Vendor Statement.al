report 18123356 "EOS Vendor Statement"
{

    DefaultLayout = RDLC;
    RDLCLayout = './source/Report/report 18123356 EOS Vendor Statement.rdlc';
    Caption = 'Vendor Statement (CVS)';
    ...
    begin
        ...
        CompanyNameText := AssetsEngine.GetCompanyNameForReport(18123356);
        AdvCustVendStatRoutines.ResolveDateFilter(PostingDateFilterPrmtr, StartingPostingDate, EndingPostingDate);
        AdvCustVendStatRoutines.ResolveDateFilter(DueDateFilterPrmtr, StartingDueDate, EndingDueDate);
    end;
...
#pragma warning restore AL0432
    ...
    begin
        ...
        exit(AdvCustVendStatRoutines.GetPaymentMethodDescription(VendorPrint."Payment Method Code", VendorPrint."Language Code"));
    end;
