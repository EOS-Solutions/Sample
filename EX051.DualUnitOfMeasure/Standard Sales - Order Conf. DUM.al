report 51305 "Standard Sales-Order Conf DUM"
{
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                column(EOS051SecQuantity_Line; "EOS051 Sec. Quantity")
                {
                }
                column(EOS051SecQuantity_Line_Lbl; FieldCaption("EOS051 Sec. Quantity"))
                {
                }
                column(EOS051SecUoMCode_Line; "EOS051 Sec. UoM Code")
                {
                }
                column(EOS051SecUoMCode_Line_Lbl; FieldCaption("EOS051 Sec. UoM Code"))
                {
                }
                column(EOS051PriceUoMCode_Line; "EOS051 Price UoM Code")
                {
                }
                column(EOS051PriceUoMCode_Line_Lbl; FieldCaption("EOS051 Price UoM Code"))
                {
                }
                ...
                column(EOS051SecUnitPrice_Line; "EOS051 Sec. Unit Price")
                {
                }
                column(EOS051SecUnitPrice_Line_Lbl; FieldCaption("EOS051 Sec. Unit Price"))
                {
                }
    ...
    local procedure GetUOMTextSec(UOMCode: Code[10]): Text[50]
    var
        UnitOfMeasureSecondary: Record "Unit of Measure";
    begin
        if not UnitOfMeasureSecondary.Get(UOMCode) then
            exit(UOMCode);
        exit(UnitOfMeasureSecondary.Description);
    end;
