report 50404 "Purchase - Quote DUM"
{
    DefaultLayout = RDLC;
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(EOS051SecUnitPrice_Line; "Purchase Line"."EOS051 Sec. Unit Price")
                        {
                        }
                        column(EOS051SecUnitPrice_Line_Lbl; "Purchase Line".FieldCaption("EOS051 Sec. Unit Price"))
                        {
                        }
                        column(EOS051SecQuantity_Line; "Purchase Line"."EOS051 Sec. Quantity")
                        {
                        }
                        column(EOS051SecQuantity_Line_Lbl; "Purchase Line".FieldCaption("EOS051 Sec. Quantity"))
                        {
                        }
                        column(EOS051SecUoMCode_Line; "Purchase Line"."EOS051 Sec. UoM Code")
                        {
                        }
                        column(EOS051SecUoMCode_Line_Lbl; "Purchase Line".FieldCaption("EOS051 Sec. UoM Code"))
                        {
                        }
                        column(EOS051PriceUoMCode_Line; "Purchase Line"."EOS051 Price UoM Code")
                        {
                        }
                        column(EOS051PriceUoMCode_Line_Lbl; "Purchase Line".FieldCaption("EOS051 Price UoM Code"))
                        {
                        }
